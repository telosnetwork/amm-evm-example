const config = [
  ...
  },
  {
    ...
    description: [
      'We burn it. The CAKE-TLOS LP tokens from the participation fee will be decomposed. We will then use the TLOS portion to market buy the CAKE equivalent, and finally throw all of the CAKE into the weekly token burn.',
    ],
  },
  {
